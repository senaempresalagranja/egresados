    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu"> <!-- colorcar la clase "active" cuando sea necesario --> 
          ...
          <li class="active"><a href="#"><i class="fa fa-pie-chart"></i><span>Graficar</span></a></li>
    ...
    <div class="container">
 	  ...
 	  <div class="row">
        ...
        <div class="col-md-12 col-lg-4 col-md-offset-4">
          ...
          <input type="number" id="numero_ficha" class="form-control">
        </div>
  		<div class="col-md-12 box">

  			<button class="button button--antiman button--inverted-alt Graficar" type="button" type="button" onclick="graficar()" value="Graficar"><i class="icon fa fa-pie-chart"></i><span>Graficar</span></button>
  		</div>
 	  </div>

	  <div id="contenedor_graficas"></div>
...
function graficar() {
  ...
  $("#contenedor_graficas").load("graficar.php",{numero_ficha:numero_ficha});
