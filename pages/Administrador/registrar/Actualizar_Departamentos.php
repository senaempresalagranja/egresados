    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 col-lg-7 col-lg-offset-4" data-form-type="formoid">
          <?php  $id=$_REQUEST['id']; 
            ...
            $busqueda=" SELECT * FROM `departamentos` WHERE id_Departamento=$id"; 
            $query=mysqli_query($conexion,$busqueda); 
            $fila=mysqli_fetch_row($query); 
            echo " 
              <div class='col-xs-12 col-md-7'>
                <div class='form-group'>
                  <input type='hidden' value='$id' id='id_Departamento'/> 
                  <label class='form-control-label' for='nombre_Departamento'> Departamentos </label> 
                  <input  class='form-control' onkeyup='validar_nombre_Departamento()' id='nombre_Departamento' type='text' value='$fila[1]'/> 
                </div> 
              </div> "; ?>
      ...
      <div class="row">
        <div class="col-xs-12  box">
          <button class="button button--antiman button--inverted-alt Actualizar" type="button" value="Acceder" onclick="actualizar()">
              <i class="icon fa fa-refresh"></i><span>Actualizar</span></button>
        </div>
      </div> 
    </div>
    <div id="resultado">
...
function actualizar() {
    if (validar_nombre_Departamento() == true) {
        ...
        $("#resultado").load("actualizar/conex_Actu-Departamentos.php", {
